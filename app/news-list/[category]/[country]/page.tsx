...
//     fetch(
//       `https://newsdata.io/api/1/latest?apikey=${api_key}&category=${resolvedParams.category}&country=${resolvedParams.country}`,
//       {
//         method: "GET",
//       }
//     )
...
//       .then((data) => {
//         const newList: INews[] = data.results.map((item: any) => ({
//           id: item.article_id,
//           title: item.title,
...
//         <div>
//           <h1>
//             {params.country} {params.category} News
//           </h1>
